export default {
  ...
  login: {
    ...
    signInDesc: 'DataPie, a big data platform for AI and BI!',
    ...
    codePlaceholder: 'Please input security code',
    mobilePlaceholder: 'Please input mobile number or email address',
