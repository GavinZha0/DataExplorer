...
import {getWebStorage, Index, setWebStorage} from '/@/utils/cache';
...
export const useMultipleTabStore = defineStore({
  ...
  state: (): MultipleTabState => ({
    ...
    // multiple tab list
    tabList: cacheTab ? getWebStorage(MULTIPLE_TABS_KEY) || [] : [],
  ...
  actions: {
    ...
    async addTab(route: RouteLocationNormalized) {
      ...
      // 404/login page does not need to add a tab
      if (
      ...
      this.updateCacheTab();
      //cacheTab && Index.setLocal(MULTIPLE_TABS_KEY, this.tabList);
      cacheTab && setWebStorage(MULTIPLE_TABS_KEY, this.tabList);
    },
