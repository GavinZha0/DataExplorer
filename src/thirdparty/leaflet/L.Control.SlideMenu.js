L.Control.SlideMenu = L.Control.extend({
    ...
    onAdd: function(map){
        ...
        L.DomUtil.create('span', 'slidemenu-image', link);
        ...
        if(this._isHorizontal){
            if(this._isLeftPosition){
                ...
                L.DomUtil.addClass(closeButton, 'slide-button-close-left');
            }
            else{
                closeButton.style.float = 'left';
                L.DomUtil.addClass(closeButton, 'slide-button-close-right');
            }
        }
        else{
            if(this._isTopPosition){
                closeButton.style.float = 'right';
                L.DomUtil.addClass(closeButton, 'slide-button-close-up');
            }
            else{
                closeButton.style.float = 'right';
                L.DomUtil.addClass(closeButton, 'slide-button-close-down');
            }
        }
...
export const SlideMenu = function(innerHTML, options) {
