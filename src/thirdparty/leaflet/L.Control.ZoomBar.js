...
L.Control.ZoomBar = L.Control.extend({
  ...
  _startElastic: function (e) {
    ...
    this._zoomRect = L.rectangle(this._zoomBounds, this._zoomRectStyle).addTo(this._map);
  ...
  _stopElastic: function (e) {
    ...
    this._map.fitBounds(this._zoomBounds);
    ...
    L.rectangle(bounds, { color: '#ff7800', weight: 1, zIndex: -1 }).addTo(this._map);
  },
...
export const ZoomBar = function (options) {
