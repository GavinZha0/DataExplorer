    ...
    L.BeautifyIcon = {
        ...
        Icon: L.Icon.extend({
            ...
            options: {
               ...
               , iconShape: 'circle'
               , iconStyle: ''
               , innerIconAnchor: [0, 10] // circle with fa or glyphicon or marker with text
               , innerIconStyle: ''
            ...
            createIconInnerHtml: function () {
                ...
                return '<i class="' + options.prefix + ' ' + options.subfix + '-' + options.icon + spinClass + '" style="' + innerIconStyle + '"></i>';
            },
